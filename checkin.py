...
async def main():
    ...
    for i, account in enumerate(accounts):
        ...
        try:
            ...
            if success:
                ...
                # ==============================
                # 增加失败情况记录 (Cookie失效/未响应等)
                # ==============================
                need_notify = True
                account_name = account.get_display_name(i)
                error_detail = "可能 Cookie 已失效或接口请求失败"
                
                # 尝试抓取具体报错信息以供排查
                if user_info_before and not user_info_before.get('success'):
                    error_detail = user_info_before.get('error', error_detail)
                    
                fail_msg = f'[CHECK-IN] {account_name}\n  ━━━━━━━━━━━━━━━━━━━━\n  ❌ 签到失败\n  ⚠️ 原因: {error_detail}\n  ━━━━━━━━━━━━━━━━━━━━'
                notification_content.append(fail_msg)
            ...
            if account_key in account_check_in_details:
                ...
                if has_balance_change:
                    ...
                    if not any(account_name in item for item in notification_content):
                        ...
                        print(f'[NOTIFY] {account_name} has balance changes, added to notification.')
    ...
    if need_notify and notification_content:
        ...
        print('[INFO] No balance changes detected and no failures, notification skipped')
